...
export const HistorialVulnerabilidades = sequelize.define(
    "tb_historial_vulnerabilidades",
    {
        int_historial_vulnerabilidades_id:{
        ...
        bln_historial_vulnerabilidades_activo:{
